...
public class PowergridMidPowerInformationViewAdapter extends BaseAdapter {
    ...
    public PowergridMidPowerInformationViewAdapter(Activity context, List<PowerGridInformation> informationViewList) {
        ...
        params = new TableLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                (int) ((getDeviceHeight(context) - getStatusBarHeight()) / 4) / 2);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.powergrid_information_small, null);
